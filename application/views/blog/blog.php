        ...
        <div class="container">
         ...
         _________________________________________________________ -->
            ...
            <div class="col-sm-9" id="blog-listing">
                ...
                <div class="post">
                    <h2><a href="post.html">Bandeira e brasão de armas da Polônia</a></h2>
                    <p class="author-category">Pelo <a href="#">Adminm</a>
                    </p>
                    <hr>
                    <p class="date-comments">
                        <a href="post.html"><i class="fa fa-calendar-o"></i>14 de junho 2017</a>
                    </p>
                    <div class="image">
                        <a href="post.html">
                            <img src="img/polska/polska.jpg" class="img-responsive" alt="Example blog post alt">
                        </a>
                    </div>
                ...
                <div class="post">
                    <h2><a href="post2.html">Kaszebe</a></h2>
                    <p class="author-category">Pelo <a href="#">Adminm</a>
                    </p>
                    <hr>
                    <p class="date-comments">
                        <a href="post2.html"><i class="fa fa-calendar-o"></i> 15 de junho 2017</a>
                    </p>
                    <div class="image">
                        <a href="post2.html">
                    ...
                    <p class="read-more"><a href="post2.html" class="btn btn-primary">Ler mais...</a>
                    </p>
                </div>
